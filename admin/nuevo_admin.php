...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
  ...
  <!-- Tooltips inicializados para Bootstrap 5 -->
  <script>
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">María Eugenia Cocco</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    María Eugenia Cocco - Desarrolladora Web
                    <small>Miembro desde Oct. 2009</small>
                  </p>
                </li>
                <!--end::User Image-->
                <!--begin::Menu Body-->
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item">
                           <a href="#" class="misdatos nav-link" data-id="<?php echo $_SESSION['imps']['IDPERSONA'];?>" >
                          <i class="nav-icon bi bi-circle"></i>
                          <p>Mis Datos</p>
                        </a>
                      </li>
