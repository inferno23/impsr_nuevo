...
if (isset($_GET['id'])) {
    $id=$_GET['id'];
    $query="SELECT a.*,b.nombre nomseccion FROM novedades a LEFT JOIN novedades_secciones b ON a.seccion=b.id WHERE a.id='$id'";
    $not=mysqli_query($con, $query);
    $rown=mysqli_fetch_assoc($not);
				...
				<div class="col-lg-9">
					<article class="border">
			        	<div class="novedades_principal">
							  ...
							  <div class="novedades_seccion"><?php echo $rown['nomseccion']?></div>
							  <div class="novedades_imagen" style="position: relative;">
							  	<img class="imagen" alt="<?php echo $rown['titulo']?>" src="<?php echo $rown['imagen'];?>">
							  	<div class="mascara"></div>
							  </div>
							  <a href="#" class="contenido">
							    <div class="fecha"><?php echo $rown['fecha']?></div>
							    <div class="titulo"><?php echo $rown['titulo'];?></div>
							    
							  </a>
							</div>
						<div class="novedades_cuerpo my-3 mb-3">
							<div class="bajada my-2"><p><?php echo $rown['subtitulo'];?></p></div>
							<p><?php echo $rown['contenido'];?></p>
						</div>	
					</article>
				</div>
				<div class="col-lg-3">
