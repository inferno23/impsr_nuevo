...
$query_usu = "SELECT a.LEGAJO,a.CLAVE,a.IDPERSONA,a.CUIL,a.APELLYNOMBRE,a.TELEFONO,a.celular,b.NROJUBILADO,b.NROPEN FROM personas a LEFT JOIN municxper b ON a.IDPERSONA=b.IDPERSONA WHERE a.LEGAJO='0' AND a.IDPERSONA>'0' ";
	      	...
	      	<div class="form-group row">
            	<div class="input-group col-12 ">
            		...
            		<div class="input-group-append">
            			<button type="button" class="btn"  id="mostrar"><i class="fas fa-eye" id="ver" ></i></button>
            		</div>
            	</div>
            </div>
            <div class="form-group row">	
