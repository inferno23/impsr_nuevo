	...
	<div class="container pb-4" id="solicitar-turnos" >
		...
		<div class="row">
	   	...
	   	<div class="row">
	   		<div class="col-12">
    			<div class="card">
              		<div class="card-header" id="card-titulo">Gestión de Turnos - Anulación</div>
              		<div class="card-body">
	...
	$('#formAnular').submit(function(e){
		...
		$.ajax({
			...
			success: function(data){
				if (data.success){
					if (!confirm("Esta seguro de que desea eliminar turno a nombre de "+data.datos.nombre+" "+data.datos.apellido+"?")) 
    					{	return false; }
    				else { 
        				$.post('functions/anular_turno.php',{id:data.datos.id},function(data2){
							if(data2.success){
