...
<head>
  ...
  <title>Calendario Jubilaciones</title>
...
<body>
  <h2 style="text-align:center;">Bloqueo de días en Jubilaciones y Pensiones</h2>
  ...
  <a href="../index.php" class="boton-regreso"> ← Volver al Menú Principal</a>
   ...
   <div class="info">
    ...
    <div class="legend">
      ...
      <span class="legend-text">Jubilaciones</span>
  ...
  <div class="info">
    ...
    <div class="legend">
      ...
      <span class="legend-textFeriado">Feriado </span>
      <span class="legend-chip"></span>
      <span class="legend-text">Jubilaciones y pensiones </span>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: function(fetchInfo, successCallback, failureCallback) {
          ...
          const url = 'get_feriados.php?' + params.toString();
          console.log('[get_feriados.php] Params:', {
        ...
        dateClick: function(info) {
          ...
          const opciones = [
            { label: 'Jubilaciones', sub: 'jubilaciones', cond: 'bloquedo' },
