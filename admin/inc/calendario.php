  ...
  <a href="../index.php" class="boton-regreso"> ← Volver al Menú Principal</a>
   ...
   <div class="info">
    ...
    <div class="legend">
      ...
      <span class="legend-textsolicitudPasivo">Solicitud Pasivo </span>
    </div>
  </div>
      ...
      const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        dateClick: function(info) {
          ...
          const opciones = [
            ...
            { label: 'Renovación - Activo', sub: 'renovacion', cond: 'activo' },
            { label: 'Renovación - Pasivo', sub: 'renovacion', cond: 'pasivo' },
            { label: 'Solicitud - Activo', sub: 'solicitud', cond: 'activo' },
            { label: 'Solicitud - Pasivo', sub: 'solicitud', cond: 'pasivo' }
          ];
