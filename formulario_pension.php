        ...
        <form id="formDatos" role="form" class="form" method="post">
            ...
            <div class="row mt-2">
          	...
          	<div class="row mt-2">
				...
				<div class="col-12 col-sm-3 input-group mb-2">
                  ...
                  <input type="text" style="text-transform: uppercase;" class="form-control"  name="beneficio1tipo">
                </div>
                <div class="col-12 col-sm-3 input-group mb-2">
          		  <div class="input-group-prepend">
                    <span class="input-group-text" >Caja o Inst.</span>
                  </div>
                  <input type="text" style="text-transform: uppercase;" class="form-control"  name="beneficio1caja">
                </div>
                <div class="col-12 col-sm-3 input-group mb-2">
          		  <div class="input-group-prepend">
                    <span class="input-group-text" >Nro.</span>
                  </div>
                  <input type="text" style="text-transform: uppercase;" class="form-control"  name="beneficio1nro">
                </div>
			</div>
			<!-- 
			<div class="row mt-2">
			...
			<div class="row mt-2">
				...
				<div class="col-12 col-sm-6 input-group mb-2">
                  ...
                  <input type="text"  style="text-transform: uppercase;" class="form-control"  name="trabajanombre">
                </div>
            ...
            <div class="row mt-2">
                  ...
                  <input type="text" style="text-transform: uppercase;" class="form-control" name="causantenombre" >
                </div>
                <div class="col-12 col-sm-4 input-group mb-2">
          		  <div class="input-group-prepend">
                    <span class="input-group-text" >DNI</span>
          	...
          	<div class="row mt-2">
                  ...
                  <select class="custom-select"  name="causanteestado">
                  	...
                  	<option value="DIVORCIADO/A">DIVORCIADO/A</option>
                  	<option value="VIUDO/A">VIUDO/A</option>
                  	<option value="SEPARADO">SEPARADO DE HECHO>
                  </select>
                </div>
                <div class="col-12 col-sm-4 input-group mb-2">
          		  <div class="input-group-prepend">
                ...
                <div class="col-12 col-sm-4 input-group mb-2">
                  ...
                  <input type="text" style="text-transform: uppercase;" class="form-control" name="causantelugar">
                </div>
          	</div>
          	<div class="row mt-2">
          		<div class="col-12 col-sm-6 input-group mb-2">
                  ...
                  <input type="text" style="text-transform: uppercase;" class="form-control" name="causantenrojub" >
                </div>
                <div class="col-12 col-sm-6 input-group mb-2">
          		  <div class="input-group-prepend">
                    <span class="input-group-text" >En caso de ser activo <br>consignar nro de leg. y dep.</span>
                  </div>
                  <input type="text"  style="text-transform: uppercase;" class="form-control" name="causanteactivo">
                </div>
            </div>
          	<hr>
          	<!-- hoja 2 -
      ...
      <p style="margin-top: 50px;margin-bottom: -4px;">(En el caso de que el/la solicitante sea hijo menor o incapacitado y este representado por un tutor o curador,se debera consignar los datos de este).</p>
			<h2>Datos curador o tutor</h2>
          	<div class="row mt-2">
                  ...
                  <input type="text" style="text-transform: uppercase;" class="form-control" name="tutornombre" >
                </div>
                <div class="col-12 col-sm-6 input-group mb-2">
          		  <div class="input-group-prepend">
                    <span class="input-group-text" >DNI</span>
          	...
          	<div class="row mt-2">
                ...
                <div class="col-12 col-sm-5 input-group mb-2">
                    ...
                    <span class="input-group-text" >Parentesco o Prof. hab.</span>
                        ...
                        <select type="text" class="form-control" name="tutorparentesco">
                       <option ></option>';
                    <?php 
            ...
            <div class="col-12 col-sm-5 input-group mb-2">
                ...
                <div class="input-group-prepend">
                  ...
                  <select type="text" class="form-control" id="apocp" name="tutorcp"><option ></option></select>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-7 col-sm-5 input-group mb-2">
                  ...
                  <input type="text" style="text-transform: uppercase;" class="form-control"  name="tutorcalle">
                </div>
                <div class="col-5 col-sm-3 input-group mb-2">
          		  <div class="input-group-prepend">
                    <span class="input-group-text" >Altura</span>
                  </div>
                  <input type="text" style="text-transform: uppercase;" class="form-control"  name="tutoraltura">
                </div>
                <div class="col-6 col-sm-2 input-group mb-2">
          		  <div class="input-group-prepend">
                    <span class="input-group-text" >Piso</span>
                  </div>
                  <input type="text" style="text-transform: uppercase;" class="form-control" name="tutorpiso" >
                </div>
                <div class="col-6 col-sm-2 input-group mb-2">
          		  <div class="input-group-prepend">
                    <span class="input-group-text" >Dpto</span>
                  </div>
                  <input type="text" style="text-transform: uppercase;" class="form-control" name="tutordpto" >
                </div>
          	</div>
        ...
        <div class="col-12 col-sm-12 mb-2">    
          <label>En el caso de que el/la solicitante sea hijo menor o incapacitado y este representado por un tutor o curador, se deberán consignar los datos de este).-
</label> 
          <label>En el caso de que hubiera un apoderado para trámite, adjunto del tutor o curador, se deberá anexar poder aparte donde titular, tutor o curador autoriza a tramitar.-</label>
              
          <label>Manifiesto en carácter de declaración jurada que el hijo menor de 25 años que estudia o es incapacitado, no percibe beneficio previcional ni realiza tareas remuneradas, es soltero y estaba a cargo del causante.-</label>
          <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <div class="input-group-text">
                          <input type="checkbox" name="manifiesto3" value="3" >
                        </div>
                        <div class="input-group-append">
...
$('#tablaDetalle tbody').on('input', 'tr:last-child td', function() {
  ...
  if (allFilled) {
	...
	function descargaPDF2(datos){
      ...
      var splitTitle22 = doc.splitTextToSize('En el caso de que hubiera un apoderado para trámite, adjunto del tutor o curador, se deberá anexar poder aparte donde titular, tutor o curador autoriza a tramitar.-', 500);
      ...
      var splitTitle222 = doc.splitTextToSize('Manifiesto en carácter de declaración jurada que el hijo menor de 25 años que estudia o es incapacitado, no percibe beneficio previcional ni realiza tareas remuneradas, es soltero y estaba a cargo del causante.-', 500);
      ...
      doc.setFont('Helvetica','bold').text(x+5,y,'Observaciones :').setFont('Helvetica','normal');
			...
			yf=572+10;
      doc.setFont('Helvetica', 'bold');
      doc.text(x,y-25,nombredni);
			var texto='INFORMACION NECESARIA PARA LA PERSONA BENEFICIARIA DE PENSIÓN';
      ...
      doc.setFontSize(12);
			...
			y=y+15;
       doc.setFontSize(10);
			var info2 = doc.splitTextToSize('Una vez presentada la documentación para obtener el beneficio de Pensión, deberá concurrir a la brevedad con su DNI en el sector IAPOS (Box nº 4), a efectos de verificar su continuidad en la obra solcial según corresponda.-', 520);
      ...
      doc.setFontSize(12);
			...
			y=y+15;
       doc.setFontSize(10);
			var info3 = doc.splitTextToSize('En caso de tener que declarar deducciones del impuesto a las ganancias, deberá ingresarlas en la página de AFIP (www.afip.gob.ar) con clave fiscal, en el servicio SIRADIG y declarando al I.M.S.R. como empleador (CUIT Nº: 30628014562).-', 5200)
       ...
       doc.setFontSize(12);
			...
			y=y+15;
       doc.setFontSize(10);
			var info4 = doc.splitTextToSize('Si la persona causante del beneficio estaba afiliada al Sindicato Municipal de Rosario, ese descuento se traslada automáticamente al beneficio de la Pensión. La persona beneficiaria deberá comunicar a las demás Instituciones a las cuales quiere estar afiliada, el número de Pensión asignado una vez que haya percibido el primer haber-', 520);
       ...
       doc.setFontSize(12);
			...
			y=y+15;
       doc.setFontSize(10);
			var info5 = doc.splitTextToSize('El depósito del Haber de Pensión se realiza en una nueva caja de ahorro del Banco Municipal, la que deberá aceptar la persona beneficiaria o apoderada. Dicha aceptación se debe manifestar una vez percibido el primer haber-', 520);
       ...
       doc.setFontSize(12);
			...
			y=y+15;
       doc.setFontSize(10);
			var info5 = doc.splitTextToSize('Para que la persona apoderada sea también co-titular de su caja de ahorros bancaria, deberá solicitar en el Instituto la constancia de poder impresa, la que será requerida por el Banco Municipal.-', 520);
			doc.text(x+5,y,info5,{maxWidth: 520, align: "justify"});
			y=y+40;
			//doc.setFont('Helvetica', 'bold');		
			doc.setFont('Helvetica', 'normal');			
       ...
       doc.setFontSize(10);
           ...
           // doc.line(578,y,578,y+210);
			...
			doc.text(x+5,y-10,'quién certifica');
			doc.text(c+c+x+5,y-30,'Aclaración y cargo');
			doc.text(c+c+x+5,y-10,'de quién certifica');
			y=y+60; 
			doc.line(x,y,yf,y);
			doc.text(x+5,y-30,'Firma de quién');
			...
			doc.save('formulario_pension.pdf'); 
