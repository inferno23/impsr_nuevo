...
$id=$_POST['id'];
$titulo=$_POST['titulo'];
$he=$conectar->query("SELECT a.mail,a.LEGAJO,a.CLAVE,a.IDPERSONA,a.CUIL,a.APELLYNOMBRE,a.TELEFONO,a.celular,b.NROJUBILADO,b.NROPEN FROM personas a LEFT JOIN municxper b ON a.IDPERSONA=b.IDPERSONA WHERE a.IDPERSONA='$id'");
$row=$he->fetch_assoc();
$asunto="Notificacion desde imps";
$cuerpo="<h1>Estimado ".$row['APELLYNOMBRE']."</h1><p> NRO JUBILACION : #".$row['NROJUBILADO']."</p><p>LE ENVIAMOS ESTA NOTIFICACION Con PDF ADJUNTO</p>";
