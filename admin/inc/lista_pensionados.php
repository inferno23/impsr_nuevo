...
$query_usu = "SELECT a.mail,a.mail2,a.LEGAJO,a.CLAVE,a.IDPERSONA,a.CUIL,a.APELLYNOMBRE,a.TELEFONO,a.celular,c.NROJUBILADO,c.NROPEN FROM personas a LEFT JOIN causante b ON a.IDPERSONA=b.IDPERSONA LEFT JOIN municxper c ON b.IDPER=c.IDPERSONA WHERE a.IDPERSONA>0 AND (c.NROPEN>0 OR c.NROPEN<> NULL)";
...
$(function() {
	...
	//$('.clave').click(function(e){
		e.preventDefault();
		var id=$(this).data('id');
		$.post( "inc/carga_pensionado.php",{ id:id }, function( json ) {
			if (json.success){
			   // console.log(json);
    			$('#id1').val(id);
    			$('#cnombre').val(json.usu.APELLYNOMBRE);
    			$('#nbene').val(json.usu.NROJUBILADO);
    			$('#npen').val(json.usu.NROPEN);
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-header">
	        	<h5 class="modal-title" id="modal-titulo-not" style="color:white">Enviar Notificacion</h5>
    	        <button  type="button" style="margin-left:100px" class="close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body" id="aimprimirT">
            ...
            <div class="form-group row"> 
                	<div class="input-group col-12">
                		<div class="input-group-prepend">
                        	<span class="input-group-text">Nro Pensionado</span>
                        </div>	
                		<input class="form-control" disabled type="text" name="npen" id="npen"  />
                	</div>
            </div>
	      	<div class="form-group row">
            	<div class="input-group col-12 ">
